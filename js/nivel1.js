...
//console.log("Hola me llamo Camilo!");
...
//console.log("nombreDeVarialbe es " + nombreDeVariable);
...
//console.log("El restultado es " + resultadoMultiplicacion);
...
const miEdad = restar(anioActual, anioNacimiento);
