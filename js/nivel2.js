...
const comidasFavoritas = ["pizza", "milanesas de seitán", "empanadas", "pastas"];
...
//     console.log(`${comidasFavoritas[i]} es una de mis comidas favoritas!!`)
// }
