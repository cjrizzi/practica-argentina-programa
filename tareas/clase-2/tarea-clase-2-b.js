...
let numero1 = Number(prompt("Indique el primer número a operar."));
let operador = prompt("Indique el operador de SUMA (+) o RESTA (-).");
let numero2 = Number(prompt("Indique el segundo número a operar."));
let resultado;
